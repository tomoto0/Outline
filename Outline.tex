...
\end{tikzpicture}
\caption{Proportion of Employed Persons Aged 15 and Over by Occupation, Employment types, and Sex - Fukushima Prefecture (2010)}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{income_changes_table.png}  % 幅を本文の80%に設定
