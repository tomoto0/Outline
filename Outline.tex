...
Figure 2 depicts a time-series graph showing the proportion of women job seekers among total new job applications submitted to Hello Work in Fukushima Prefecture. A higher proportion suggests a narrowing gender employment gap. 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{Women ratio on the number of active job seekers.jpeg}  % 幅を本文の80%に設定
    \caption{Women ratio on the number of active job seekers in Fukushima Pref.}
    \label{fig:women_ratio_fukushima}
\end{figure}

Labor market trends in Fukushima Prefecture over the past two decades can be divided into three phases. During the 2008-2010 global financial crisis, overall job seekers increased, but the proportion of female job seekers decreased, indicating a stronger impact on male employment. However, the aftermath of the Great East Japan Earthquake in 2011 saw a sustained elevation in the proportion of female job seekers. This trend persisted throughout the post-disaster period, indicating an increasing of women job seekers. Since 2020, the COVID-19 pandemic has led to a slight decline in the female share of job seekers. 

\newpage

Figure 4 presents a line graph illustrating the number of applicants for public unemployment insurance (Employment Insurance) in Fukushima Prefecture, along with the proportion of female applicants relative to total applicants. The graph also includes the national average for comparison. 
